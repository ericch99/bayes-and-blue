...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, 'ExtremeWeather')  # create a path '/path/to/data/trainA'
        self.dir_B = os.path.join(opt.dataroot, 'slp_resized')  # create a path '/path/to/data/trainB'
        print(opt.dataroot)
        print(opt.phase)
